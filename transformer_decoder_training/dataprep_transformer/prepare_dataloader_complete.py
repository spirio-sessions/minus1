...
def prepare_dataset_as_dataloaders_no_test(dataset_dir: str, snapshot_intervall: int, batch_size: int, seq_length: int,
                                   stride: int, test_size: int, sos_token: np.ndarray, amount=-1):
    """
    ...
    # split songs into train, test and val
    train_data, val_data = train_test_split(dataset_as_snapshots, test_size=test_size, random_state=42, shuffle=True)
